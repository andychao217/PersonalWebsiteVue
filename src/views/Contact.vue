<template>
  <div class="scrollDiv" :style="{overflowY:'auto', height: contentHeight - 40 + 'px', minHeight: '350px'}">
    <a-row>
      <baidu-map
        ak="M4Pb27gO9W9y3e5ciPVXoDFnFdYjHk5O"
        :center="center" 
        :zoom="zoom"
      ...
      >
        ...
        <bm-marker 
          :position="{lng: 112.979, lat: 28.213}" 
          :dragging="false" 
